...
namespace rbkUtilities
{
    public class SyntaxHighlightService
    {
        ...
        public void ProcessSyntaxHighlight(object sender, TextChangedEventArgs e)
        {
            ...
            e.ChangedRange.SetStyle(Keywords, @"\s(eq|neq|gr|ge|true|false)\s", RegexOptions.Multiline | RegexOptions.IgnoreCase);
            ...
            e.ChangedRange.SetStyle(StructuralKeywords, @"^(pml\s+reload\s+form|call|show|return|import|handle|endhandle|using\s+namespace)", RegexOptions.Multiline | RegexOptions.IgnoreCase);

            //conditionals and loops
            e.ChangedRange.SetStyle(StructuralKeywords, @"\b(if|else|endif|do|enddo|var)\s", RegexOptions.Multiline | RegexOptions.IgnoreCase);
